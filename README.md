...
Final model's architecture which is a meta-learning algorithm is described below. The individual estimators provide outputs that are used as inputs by the final estimator to provide the outputs:
